...
from coinquant.event.engine import EventEngine
...
from coinquant.trader.gateway import BaseGateway
from coinquant.trader.utility import round_to, ZoneInfo
...
from coinquant_rest import Request, RestClient
from coinquant_websocket import WebsocketClient
...
class OkxGateway(BaseGateway):
    ...
    exchanges: List[Exchange] = [Exchange.OKX]
