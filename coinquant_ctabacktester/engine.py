...
from coinquant.trader.engine import BaseEngine, MainEngine
from coinquant.trader.constant import Interval
from coinquant.trader.utility import extract_vt_symbol
from coinquant.trader.object import HistoryRequest, TickData, ContractData, BarData
from coinquant.trader.datafeed import BaseDatafeed, get_datafeed
from coinquant.trader.database import BaseDatabase, get_database

import coinquant_ctastrategy
from coinquant_ctastrategy import CtaTemplate, TargetPosTemplate
from coinquant_ctastrategy.backtesting import (
    BacktestingEngine,
    OptimizationSetting,
    BacktestingMode
)
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self) -> None:
        ...
        """
        app_path: Path = Path(coinquant_ctastrategy.__file__).parent
        path1: Path = app_path.joinpath("strategies")
        self.load_strategy_class_from_folder(path1, "coinquant_ctastrategy.strategies")
