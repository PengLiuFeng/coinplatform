...
from coinquant.trader.constant import Interval, Direction, Exchange
from coinquant.trader.engine import MainEngine, BaseEngine
from coinquant.trader.ui import QtCore, QtWidgets, QtGui
from coinquant.trader.ui.widget import BaseMonitor, BaseCell, DirectionCell, EnumCell
from coinquant.event import Event, EventEngine
from coinquant.chart import ChartWidget, CandleItem, VolumeItem
from coinquant.trader.utility import load_json, save_json
from coinquant.trader.object import BarData, TradeData, OrderData
from coinquant.trader.database import DB_TZ
from coinquant_ctastrategy.backtesting import DailyResult
...
class BacktesterManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.symbol_line: QtWidgets.QLineEdit = QtWidgets.QLineEdit("BTC-USDT-SWAP.OKX")
